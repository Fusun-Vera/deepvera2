      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4 bg-slate-50 px-5 py-2 rounded-2xl border border-slate-100 group">
           <div className="flex flex-col items-end leading-none">
              ...
              <span className="text-[7px] font-black uppercase tracking-[0.1em] text-slate-400 mt-0.5">TOKEN</span>
           </div>
           <button 
             onClick={onBuyTokens}
        ...
        {/* Settings Button - n8n buraya tıklandığında açılır */}
        <button 
