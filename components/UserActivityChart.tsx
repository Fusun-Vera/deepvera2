      ...
      <div className="flex justify-end items-center mb-8">
        <div className="flex gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[9px] font-black text-slate-500 uppercase">Token</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_8px_#10b981]"></div>
            <span className="text-[9px] font-black text-slate-500 uppercase">Analiz</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-slate-900"></div>
            <span className="text-[9px] font-black text-slate-500 uppercase">Giriş</span>
          </div>
        </div>
      </div>
